...
Either fil_matrix_double_test_either(matrix_t** z, int rows, int cols, char* buffer, Test* test) {
    TEST_START(test);

    *z = new_matrix(get_table_matrix_Double(), rows, cols, get_type_element_Double());
    ...
    for (int i = 0; i < rows; i++) {
        for (int j = 0; j < cols; j++) {
            ...
            if (sscanf(token, "%lf", &elem.value) != 1) {
...
void fil_matrix_double_test(matrix_t** z, int rows, int cols, char* buffer, Test* test) {
    Either examp = fil_matrix_double_test_either(z, rows, cols, buffer, test);
...
void add_matrix_double_test(matrix_t* a1, matrix_t* a2, matrix_t** resul, char* buffer, Test* test) {
    TEST_START(test);
...
void multi_matrix_double_test(matrix_t* a1, matrix_t* a2, matrix_t** resul, char* buffer, Test* test) {
    TEST_START(test);
...
void transposing_matrix_double_test(matrix_t* a1, matrix_t** resul, char* buffer, Test* test) {
    TEST_START(test);
...
void skal_matrix_double_test(matrix_t* a1, Double* skal, matrix_t** resul, char* buffer, Test* test) {
    TEST_START(test);
