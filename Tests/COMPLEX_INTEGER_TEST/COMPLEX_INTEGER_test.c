#include "COMPLEX_INTEGER_test.h"
#include "../Test.h"
#include <stdlib.h>
#include <stdio.h>


Either fil_matrix_complex_integer_test_either(matrix_t** z, int rows, int cols, char* buffer, Test* test) {
    TEST_START(test);

    *z = new_matrix(get_table_matrix_complex_integer(), rows, cols, get_type_element_complex_integer());
    ...
    for (int i = 0; i < rows; i++) {
        for (int j = 0; j < cols; j++) {
            ...
            if (sscanf(token, "(%d+%di)", &elem.Re, &elem.Im) != 2) {
...
void fil_matrix_complex_integer_test(matrix_t** z, int rows, int cols, char* buffer, Test* test) {
    Either examp = fil_matrix_complex_integer_test_either(z, rows, cols, buffer, test);
...
void add_matrix_complex_integer_test(matrix_t* a1, matrix_t* a2, matrix_t** resul, char* buffer, Test* test) {
    TEST_START(test);
...
void multi_matrix_complex_integer_test(matrix_t* a1, matrix_t* a2, matrix_t** resul, char* buffer, Test* test) {
    TEST_START(test);
...
void transposing_matrix_complex_integer_test(matrix_t* a1, matrix_t** resul, char* buffer, Test* test) {
    TEST_START(test);
...
void skal_matrix_complex_integer_test(matrix_t* a1, complex_integer* skal, matrix_t** resul, char* buffer, Test* test) {
    TEST_START(test);
